...
print("comeco codigo")
caminhoCodigo = '/home/hugo/Documents/Mestrado/codigoRastreador/bin/Debug/tracker'
caminhoBD = '/home/hugo/Documents/Mestrado/alov_dataset/alov300'
subpasta = 'videos'
pastaAlteracao = 'alteracao'
    ...
    for categoria in categorias:
        ...
        for video in videos:
            ...
            if videoGrande(caminhoBD,subpasta,categoria,video,4000): #4000MB de memoria o video ja e grande
                ...
                comando = caminhoCodigo + ' ' + caminhoParam + ' ' + caminhoAlteracao
                os.system(comando)
